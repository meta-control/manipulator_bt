...
#include "manipulator_bt/behavior_tree_nodes/Pick.hpp"
...
{  
  ...
  // check selected_mode
   ...
   if (feedback_->qos_status.selected_mode == "fd_pick_left_mode")
  {
  ...
  else if (feedback_->qos_status.selected_mode == "fd_pick_right_mode")
  {
