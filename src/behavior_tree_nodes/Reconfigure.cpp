...
#include "manipulator_bt/behavior_tree_nodes/Reconfigure.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<manipulator_bt::Reconfigure>(
        name, config);
    };

  factory.registerBuilder<manipulator_bt::Reconfigure>(
    "Reconfigure", builder);
}
